...
public class UploadProcess extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		try {
			//드라이브 명으로 절대경로 지정하기 
			String saveDirectory = "E:/cgr_data/jsp_data/musthavejsp2/src/main/webapp/Uploads";
			//Uploads 디렉토리의 물리적 경로 가져오기
		    //String saveDirectory = getServletContext().getRealPath("E:/cgr_data/jsp_data/musthavejsp2/src/main/webapp/Uploads");
